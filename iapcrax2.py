# Google Play Store - Powerful multi Zero Day Android free IAP proxy exploit
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Powerful multi Zero Day Android free IAP proxy exploit')
